...
if ( ! function_exists( 'qi_addons_for_elementor_add_blog_list_variation_boxed' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_add_blog_list_variation_boxed( $variations ) {
		$variations['boxed'] = esc_html__( 'Boxed', 'qi-addons-for-elementor' );

		return $variations;
	}

	add_filter( 'qi_addons_for_elementor_filter_blog_list_layouts', 'qi_addons_for_elementor_add_blog_list_variation_boxed' );
}

if ( ! function_exists( 'qi_addons_for_elementor_load_blog_list_variation_boxed_assets' ) ) {
	/**
	 ...
	 * @return bool
	 */
	function qi_addons_for_elementor_load_blog_list_variation_boxed_assets( $is_enabled, $params ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_load_blog_list_assets', 'qi_addons_for_elementor_load_blog_list_variation_boxed_assets', 10, 2 );
}

if ( ! function_exists( 'qi_addons_for_elementor_register_blog_list_boxed_scripts' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_register_blog_list_boxed_scripts( $scripts ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_register_scripts', 'qi_addons_for_elementor_register_blog_list_boxed_scripts' );
}

if ( ! function_exists( 'qi_addons_for_elementor_register_blog_list_boxed_styles' ) ) {
	/**
	 * Function that register modules 3rd party scripts
	 *
	 * @param array $styles
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_register_blog_list_boxed_styles( $styles ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_register_styles', 'qi_addons_for_elementor_register_blog_list_boxed_styles' );
}

if ( ! function_exists( 'qi_addons_for_elementor_add_blog_list_options_boxed' ) ) {
	function qi_addons_for_elementor_add_blog_list_options_boxed( $options ) {
		$boxed_options = array();
		...
		$date_vertical_offset = array(
			'field_type' => 'slider',
			'name'       => 'boxed_date_vertical_offset',
		...
		$date_horizontal_offset = array(
			'field_type' => 'slider',
			'name'       => 'boxed_date_horizontal_offset',
		...
		$boxed_options[] = $date_border_radius;
		$boxed_options[] = $date_vertical_offset;
		$boxed_options[] = $date_horizontal_offset;

		return array_merge( $options, $boxed_options );
	}

	add_filter( 'qi_addons_for_elementor_filter_blog_list_extra_options', 'qi_addons_for_elementor_add_blog_list_options_boxed' );
}
