...
if ( ! function_exists( 'qi_addons_for_elementor_add_image_gallery_shortcode' ) ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_register_shortcodes', 'qi_addons_for_elementor_add_image_gallery_shortcode' );
}
...
if ( class_exists( 'QiAddonsForElementor_List_Shortcode' ) ) {
	class QiAddonsForElementor_ImageGallery_Shortcode extends QiAddonsForElementor_List_Shortcode {
		...
		public function map_shortcode() {
			$this->set_shortcode_path( QI_ADDONS_FOR_ELEMENTOR_SHORTCODES_URL_PATH . '/image-gallery' );
			...
			$this->set_scripts(
				apply_filters(
					'qi_addons_for_elementor_filter_image_gallery_register_scripts',
					array(
						'fslightbox' => array(
							'registered' => true,
						),
		...
		public static function call_shortcode( $params ) {
			$html = qi_addons_for_elementor_framework_call_shortcode( 'qi_addons_for_elementor_image_gallery', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return qi_addons_for_elementor_get_template_part( 'shortcodes/image-gallery', 'templates/image-gallery', $atts['behavior'], $atts );
		}

		private function get_holder_classes( $atts ) {
			$holder_classes = $this->init_holder_classes();

			$holder_classes[] = 'qodef-qi-image-gallery';
