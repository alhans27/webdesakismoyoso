...
if ( ! function_exists( 'qi_addons_for_elementor_add_product_list_variation_info_below_with_hover' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_add_product_list_variation_info_below_with_hover( $variations ) {
		$variations['info-below-with-hover'] = esc_html__( 'Info Below With Hover', 'qi-addons-for-elementor' );

		return $variations;
	}

	add_filter( 'qi_addons_for_elementor_filter_product_list_layouts', 'qi_addons_for_elementor_add_product_list_variation_info_below_with_hover' );
}

if ( ! function_exists( 'qi_addons_for_elementor_add_product_list_options_info_below_with_hover' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_add_product_list_options_info_below_with_hover( $options ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_product_list_extra_options', 'qi_addons_for_elementor_add_product_list_options_info_below_with_hover' );
}
